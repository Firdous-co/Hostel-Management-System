...
public class fee extends Frame { 
	...
	{ 
		...
		String language[] 
			= { "N.B.H", "O.B.H", "N.B.A","O.B.A","K.V","GIRLS HOSTEL" }; 
		...
		li1.addElement("Sunday(70 rs)"); 
		li1.addElement("Monday(70 rs)"); 
		li1.addElement("Tuesday(70 rs)"); 
		li1.addElement("Wednesday(70 rs)"); 
		li1.addElement("Thursday(70 rs)"); 
		li1.addElement("Friday(70 rs)");
		li1.addElement("Saturday(70 rs)");  
